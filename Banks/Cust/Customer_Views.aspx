<%@ Page Language="C#" MasterPageFile="~/Cust/MasterPage.master" AutoEventWireup="true" CodeFile="Customer_Views.aspx.cs" Inherits="Cust_Customer_Views" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:QueryStringParameter Name="CA_ID" QueryStringField="CA_ID" Type="Int32" />
        </SelectParameters>
        <DeleteParameters>
