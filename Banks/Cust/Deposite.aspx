<%@ Page Language="C#" MasterPageFile="~/Cust/MasterPage.master" AutoEventWireup="true" CodeFile="Deposite.aspx.cs" Inherits="Cust_Deposite" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <table width="100%">
                    <tr>
                        <td bgcolor="#5D7B9D" colspan="4" height="30">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td width="20%">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        AutoGenerateColumns="False" CellPadding="4" DataKeyNames="D_ID,CA_ID" 
        DataSourceID="SqlDataSource1" 
        EmptyDataText="There are no data records to display." ForeColor="#333333" Width="100%" 
                    AllowSorting="True">
        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" HorizontalAlign="Center" />
        <Columns>
            <asp:BoundField DataField="D_ID" HeaderText="&#1585;&#1602;&#1605; &#1575;&#1604;&#1575;&#1610;&#1583;&#1575;&#1593;" ReadOnly="True" 
                SortExpression="D_ID" />
            ...
            <asp:BoundField DataField="D_DATE" HeaderText="&#1578;&#1575;&#1585;&#1610;&#1582; &#1575;&#1604;&#1575;&#1610;&#1583;&#1575;&#1593;" 
                SortExpression="D_DATE" />
            <asp:BoundField DataField="D_CURR" HeaderText="&#1575;&#1604;&#1593;&#1605;&#1604;&#1577;" 
                SortExpression="D_CURR" />
            <asp:BoundField DataField="D_AMOUNT" HeaderText="&#1575;&#1604;&#1605;&#1576;&#1604;&#1594;" 
                SortExpression="D_AMOUNT" />
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [dep_gr_dmy]"></asp:SqlDataSource>
</asp:Content>
